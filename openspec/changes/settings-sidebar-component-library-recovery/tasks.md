...
- 2026-07-18：补充清理 `src/settings.css` 中残留的 `.settings-redesign-code-tabs*` 旧类名（已无任何 TSX/CSS 引用），避免后续被误当成功能样式维护；复跑 `pnpm test:unit`、`pnpm check:i18n`、`cargo check`、`pnpm build` 均通过。
